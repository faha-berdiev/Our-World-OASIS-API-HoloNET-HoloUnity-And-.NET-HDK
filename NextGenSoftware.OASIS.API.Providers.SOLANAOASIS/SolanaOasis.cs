...
{
    public class SolanaOasis : OASISStorageBase, IOASISStorage, IOASISNET, IOASISSuperStar
    {
        public SolanaOasis()
        {
            this.ProviderName = "SolanaOASIS";
            this.ProviderDescription = "Solana Provider";
